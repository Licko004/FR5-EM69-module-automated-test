...
Upload [plate-carry-demo.lua](https://github.com/Licko004/FR5-EM69-module-automated-test/blob/main/plate-carry-demo.lua) to the robot through the [WEB UI](#Main-program-setup) and set it as main program. Follow instructions in this README and refer to documentation.
